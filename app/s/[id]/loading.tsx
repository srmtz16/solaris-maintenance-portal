export default function Loading() {
  return <div className="min-h-[100dvh] bg-[#F5F7FA] text-stone-900" role="status" aria-label="Cargando expediente">
    <div className="border-b border-stone-200 bg-[#F5F7FA]"><div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 md:px-8"><div className="h-10 w-36 animate-pulse rounded-xl bg-stone-200" /><div className="h-8 w-24 animate-pulse rounded-full bg-stone-200" /></div></div>
