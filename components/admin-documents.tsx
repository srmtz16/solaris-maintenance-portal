...
export function AdminDocuments() {
  ...
  return <div className="space-y-8">
    <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
      <div><p className="text-[11px] font-semibold uppercase tracking-[.18em] text-[#9b7835]">Archivos reales</p><h2 className="mt-2 text-3xl font-semibold tracking-[-.035em] md:text-4xl">Documentos</h2><p className="mt-3 max-w-2xl text-sm leading-6 text-stone-500">Sube diagramas, reportes y fotografías al expediente correcto. El cliente los verá inmediatamente desde su mismo QR.</p></div>
