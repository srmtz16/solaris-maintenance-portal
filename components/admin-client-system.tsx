...
import { ArrowLeft, ExternalLink, Gauge, LoaderCircle, MapPin, Pencil, UserRound } from "lucide-react";
...
export function AdminClientSystem({ systemCode, refreshKey, onEdit }: { systemCode: string; refreshKey: number; onEdit: (system: AdminSystem) => void }) {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    setError("");
    const result = await getSupabaseBrowserClient().rpc("admin_get_portal_data");
